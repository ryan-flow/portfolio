    ...
    <Box component="section" id="contact" sx={{ py: { xs: 6, md: 10 }, textAlign: 'center' }}>
      <Container maxWidth="sm">
        <Box className="reveal">
          ...
          <Box sx={{ p: { xs: 4, md: 5 }, borderRadius: 4, border: '1px solid rgba(143,164,184,0.10)', background: 'rgba(143,164,184,0.04)', backdropFilter: 'blur(16px)', display: 'flex', flexDirection: 'column', gap: 2.5 }}>
